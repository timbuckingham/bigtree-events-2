	...
	<div style="float: left; margin: 0 0 15px 0; width: 440px;">
		<div style="float: left; margin: 0 15px 0 0;">
			<fieldset>
				...
				<input type="text" class="date_picker" id="field_start_date" autocomplete="off" value="<?php if ($start_date) { echo date("m/d/Y", strtotime($bigtree["entry"]["start_date"])); } ?>" name="start_date" tabindex="<?=$field["tabindex"]++?>" />
		...
		<div style="float: left; margin: 0 15px 15px 0;">
			<fieldset>
				...
				<input type="text" class="date_picker" id="field_end_date" autocomplete="off" value="<?php if ($end_date) { echo date("m/d/Y", strtotime($bigtree["entry"]["end_date"])); } ?>" name="end_date" tabindex="<?=$field["tabindex"]++?>" />
				<span class="icon_small icon_small_calendar date_picker_icon"></span>
			</fieldset>
		</div>
	</div>
	...
	<div style="float: right; margin: 0 0 15px 0; width: 440px;">
		<div style="float: left; margin: 0 15px 0 0;">
			<fieldset>
				...
				<input type="text" class="time_picker" id="field_start_time" autocomplete="off" value="<?php if (!empty($bigtree["entry"]["start_time"])) { echo date("g:ia", strtotime($bigtree["entry"]["start_time"])); } ?>" name="start_time" tabindex="<?=$field["tabindex"]++?>" <?php if (!empty($bigtree["entry"]["all_day"])) { ?>disabled="disabled" <?php } ?>/>
		...
		<div style="float: left; margin: 0 15px 15px 0;">
			<fieldset>
				...
				<input type="text" class="time_picker" id="field_end_time" autocomplete="off" value="<?php if (!empty($bigtree["entry"]["end_time"])) { echo date("g:ia", strtotime($bigtree["entry"]["end_time"])); } ?>" name="end_time" tabindex="<?=$field["tabindex"]++?>" <?php if (!empty($bigtree["entry"]["all_day"])) { ?>disabled="disabled" <?php } ?>/>
				<span class="icon_small icon_small_clock time_picker_icon"></span>
			</fieldset>
		</div>
